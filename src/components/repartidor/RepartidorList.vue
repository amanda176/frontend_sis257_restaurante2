      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <RouterLink to="/repartidor/crear">Crear Nuevo Repartidor </RouterLink>
          </div>
        </div>
      </div>
    </div>
          ...
          <tbody>
            ...
            >
              ...
              <td style="color: #f8cb2e">
                {{ new Date(repartidor.fechaEdad).toLocaleDateString('es-ES') }}
              </td>
              <td style="color: #f8cb2e">
                {{ new Date(repartidor.fechaIngreso).toLocaleDateString('es-ES') }}
              </td>
              <td>
